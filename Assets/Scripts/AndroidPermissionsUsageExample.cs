...
public class AndroidPermissionsUsageExample : MonoBehaviour
{
    ...
    private bool CheckPermissions()
    {
        ...
        return AndroidPermissionsManagerOwn.IsPermissionGranted(STORAGE_PERMISSION);
    }

    public void OnGrantButtonPress()
    {
        AndroidPermissionsManagerOwn.RequestPermission(new []{STORAGE_PERMISSION}, new AndroidPermissionCallback(
            grantedPermission =>
            {
